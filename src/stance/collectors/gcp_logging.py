    ...
    def _collect_log_metrics(self) -> list[Asset]:
        ...
        for metric in all_metrics:
            ...
            raw_config: dict[str, Any] = {
                ...
                # Security metric flags
                "metric_for_audit_config_changes_exists": security_metrics["audit_config_changes"],
                "metric_for_iam_custom_role_changes_exists": security_metrics["iam_custom_role_changes"],
                "metric_for_vpc_firewall_changes_exists": security_metrics["vpc_network_firewall_changes"],
                "metric_for_vpc_route_changes_exists": security_metrics["vpc_network_route_changes"],
                "metric_for_vpc_network_changes_exists": security_metrics["vpc_network_changes"],
            ...
            assets.append(
                Asset(
                    ...
                    raw_config={
                        ...
                        "metric_for_iam_custom_role_changes_exists": False,
                        "metric_for_vpc_firewall_changes_exists": False,
                        "metric_for_vpc_route_changes_exists": False,
                        "metric_for_vpc_network_changes_exists": False,
